#!/usr/bin/env python3
"""Comic and ebook convert bodies (CBZ/CBR/EPUB)."""
...
import cbz_to_epub
from convert_docs import calibre_convert
...
from direct_pdf import (
    PdfPageSource,
    _direct_pdf_from_archive as _direct_pdf_from_archive_impl,
    _direct_pdf_from_paths as _direct_pdf_from_paths_impl,
    write_direct_pdf as write_direct_pdf_impl,
)

_direct_pdf_from_archive = guarded(_direct_pdf_from_archive_impl)
_direct_pdf_from_paths = guarded(_direct_pdf_from_paths_impl)
write_direct_pdf = guarded(write_direct_pdf_impl)
