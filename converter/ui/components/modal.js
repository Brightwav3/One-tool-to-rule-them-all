...
function sheetHtml() {
  ...
  return `
    <div class="sheet-head">
      ...
      ${buttonHtml({ family: 'btn', variant: 'ghost', size: 'sm', act: 'close-sheet', ariaLabel: 'Close', html: ICON.remove })}
    </div>
      ...
      <div class="sheet-right">
        ...
        <div class="sheet-routes">
          ${shown.length ? shown.map(d => {
            ...
            return optHtml({
              current, act: 'sheet-pick', to: esc(t.to), disabled,
              check: current ? tickIcon(11) : '', name: esc(t.to),
              stateClass: d.applicable ? routeStateClass(t) : '', stateLabel: esc(label),
            });
    ...
    <div class="sheet-foot">
      ...
      ${buttonHtml({ family: 'btn', variant: 'primary', act: 'apply-sheet', html: `Use this route<span class="kbd" style="background:rgba(255,255,255,.16);color:rgba(255,255,255,.72)">⏎</span>` })}
    </div>`;
}
